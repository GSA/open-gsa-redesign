...
<script type="text/javascript">
  ...
  var apiUmbrellaSignupOptions = {
    ...
    exampleApiUrl: 'https://api.gsa.gov/technology/digital-registry/v1/social_media.json?api_key={{api_key}}',
    ...
    contactUrl: 'usdigitalregistry@gsa.gov',
...
<a href="digitalregistry/v1/openapi.yaml">Open API specification file for the Sample API</a>
...
{% include swagger-section-header.html %}
    url: "digitalregistry/v1/openapi.yaml", 
...
If you have questions, comments or ideas on how to use or improve the U.S. Digital Registry, please contact us [via email](mailto:usdigitalregistry@gsa.gov).
