...
The Public Location Services API provides Location Services data (State, City, and ZIP) and is to be used when validating location data being submitted to Beta.SAM.gov ONLY
