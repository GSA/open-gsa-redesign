...
400	|	Subawardee UEI is required	|	The SAM.gov registration UEI for the subawardee is required	|	submitSubawardReport ,updateSubawardReport(Contracts and Grants) |
