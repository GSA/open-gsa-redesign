...
| 14 | sortBy                       | Field by which the response is sorted. Case insensitive. Default sorting is by submittedDate. Acceptable values:<br/>- submittedDate <br/>- lastModifiedDate<br/>Examples of Request Body:<br/>`{"sortBy": "lastModifiedDate"}`<br/>`{"sortBy": "submittedDate"}`                                                                                                                                                                                                                                                                                                    | V1                  |
| 14 | sortDirection                | Choose the sort direction for the response. Default sort direction is "descending". Acceptable values:<br/>- asc <br/>- desc <br/><br/>Examples of Request Body:<br/>`{"sortDirection": "asc"}`<br/>`{"sortDirection": "desc"}`                                                                                                                                                                                                                                                                                                                                      | V1                  |
