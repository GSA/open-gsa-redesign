...
<td>mpin</td>
<td>string</td>
<td>This field will be deprecated soon. Until then, it will return a value of null in the API response.</td>
<td>v1<br>v2<br>v3</td>
</tr>
</table>
</details>
...
| 022/24/2023 | v4.2    | *  Removed MPIN occurrences from the Data Dictionary and the “Overview” > “Sensitive (CUI) Data” section. <br><br> * Indicated that MPIN will be deprecated soon in the "Response Schema"  > "coreData"  > "entityInformation Sub Section".
