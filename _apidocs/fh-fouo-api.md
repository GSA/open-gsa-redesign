...
searchby|	Field for users to search by state code, country code, city; Search by values must be either state code, country code, or city <br> <br> *Note: Refer Appendix (section 10) for a list of state codes and country codes.* | 	Text
