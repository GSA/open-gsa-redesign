...
**Production**
* https://api.sam.gov/acquisition/v1/subawards/search
* https://api.sam.gov/acquisition/v1/subawards/search?status=Delete

**Alpha**
* https://api-alpha.sam.gov/acquisition/v1/subawards/search
* https://api-alpha.sam.gov/acquisition/v1/subawards/search?status=Delete
...
toDate | Allows users to filter by To Date. | No | string | v1
...
To Date has invalid date format. | Invalid ToDate. Date must be in format 'yyyy'MM-dd'. 
...
<code><pre>
{
    ...
    "totalRecords": 1,
    "pageNumber": 0,
    "nextPageLink": "/api/v1/search?pageNumber=1&pageSize=25",
    "previousPageLink": "/api/v1/search?pageNumber=1&pageSize=25",
    "data": [
        {
