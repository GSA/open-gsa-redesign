...
| 400 | Application Level Error Messages: <br><br>  * Application Level Error Messages:<br/>* User does not have permission to download the file. <br />* Missing required parameters, fileName OR fileType<br />* The requested extract file not found<br/>* Invalid date format |
