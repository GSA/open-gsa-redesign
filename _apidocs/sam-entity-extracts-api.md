...
06/27/2023 | v3.3    | * Updated "Effective April 2022" to "Effective June 2023". <br><br> * Updated the "June 2023 release: SAM Master Extract Mapping" STRING Clarification tab to include the following updates: <ol type="1"><li>NAICS Exception String table updated to reflect January 2023 changes</li><li>SBA Business Types String table updated to include new value: "A4- SBA Certified Small Disadvantaged Business"</li></ol>
