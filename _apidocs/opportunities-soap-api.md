...
solnbr |	string |	Yes |	Solicitation # |	128 characters from the set: a-z A-Z 0-9 - _ ( ) { } <br> *Note: To use "&", enter \\&amp;
ntype	| string |	No |	 [Refer Related Notices](#related-notices) |		
awdnbr | string |	 Yes |	Award Number |	255 characters from the set: a-z A-Z 0-9 - _ ( ) { } <br> *Note: To use "&", enter \\&amp;
awdamt |	string |	Yes |	Award Amount |	64 digits
linenbr |	string |	No |	Line Number |	255 characters from the set: a-z A-Z 0-9 - _ ( ) { } <br> *Note: To use "&", enter \\&amp;
...
Element Name | Type | Required | Description | Character Limit / Restrictions
------ | ------- | ------- | ------- | -------
solnbr |	string |	Yes - Either Solicitation # or Award # is required only for Award|	Solicitation # | 128 characters from the set: a-z 0-9 -_ ( ) { } <br> *Note: To use "&", enter \\&amp;
ntype |	string |	No; Yes if there are multiple notices with same Solicitation # | [Refer Notice Types](#notice-types)	| 
awdnbr |  string | Yes - Either Solicitation # or Award # is required ony for Award| Award # |	255 characters from the set: a-z A-Z 0-9 - _ ( ) { } <br> *Note: To use "&", enter \\&amp;
...
------ | ------- | ------- | ------- | -------
date |	date |	No |	Posting Date (Deprecated)| YYYYMMDD
solnbr | string |	Yes |	Solicitation # | 128 characters from the set: a-z 0-9 -_ ( ) { } <br> *Note: To use "&", enter \\&amp;
...
solnbr |string | Yes | Solicitation # | 128 characters from the set: a-z A-Z 0-9 - _ ( ) { } <br> *Note: To use "&", enter \\&amp;
ntype | string | No | [Refer Notice Types](#notice-types) 	| 
awdnbr | string |	No | Award # |255 characters from the set: a-z A-Z 0-9 - _ ( ) { } <br> *Note: To use "&", enter \\&amp;
archdate | date |	No | Archive Date | YYYYMMDD
contact | string | No | Contact Info | 500 characters
...
donbr	| String |	No |	Task/Delivery Order Number |	255 characters from the set: a-z A-Z 0-9 - _ ( ) <br> *Note: To use "&", enter \\&amp;
archdate  |	Date |	No |	Archive Date |	YYYYMMDD
contact |	String |	Yes | 	Contact Info |	500 characters
desc |	String |	No |	Description	| 65535 characters
...
offadd |	String |	No |	Office Address (Deprecated). The Contracting office address details are retrieved from the Federal Hierarchy	| 65535 characters
subject | 	String |	Yes |	Subject |	256 characters
solnbr	| String |	No |	Solicitation # |	128 characters from the set: a-z A-Z 0-9 -_ ( ) { } <br> *Note: To use "&", enter \\&amp;
...
offadd	|string|	No|	Office Address (Deprecated). The Contracting office address details are retrieved from the Federal Hierarchy	|65535 characters
subject|	string|	Yes|	Subject|	256 characters
solnbr|	string|	Yes, EXCEPT No - Only for SNOTE|	Solicitation #	|128 characters from the set: a-z A-Z 0-9 - _ ( ) { } <br> *Note: To use "&", enter \\&amp;
ntype	|string	|No	| [Refer Related Notices](#related-notices)
awdnbr|	string|	Yes - for AWARD, ITB & JA |	Award #	|255 characters from the set: a-z A-Z 0-9 - _ ( ) { } <br> *Note: To use "&", enter \\&amp;
donbr	|string	|No|	Delivery/Task Order Number	|	255 characters from the set: a-z A-Z 0-9 - _ ( ) <br> *Note: To use "&", enter \\&amp;
awdamt	|string|	Yes - for AWARD 	|Award Amount|	64 digits
linenbr|	string	|No|	Award Line Item Number	|255 characters from the set: a-z A-Z 0-9 - _ ( ) { } <br> *Note: To use "&", enter \\&amp;
...
solnbr	|string	|No (at least 1 field is required)	|Solicitation #| 128 characters from the set: a-z A-Z 0-9 -_ ( ) { } <br> *Note: To use "&", enter \\&amp;
awdnbr	|string	|No	(at least 1 field is required)|Award # | 255 characters from the set: a-z A-Z 0-9 - _ ( ) { } <br> *Note: To use "&", enter \\&amp;
...
linenbr|	1.If value provided does not meet the character limit/restrictions, then service throws an error	|1. The Contract Line Item number max length is 255 characters and allows only alphanumeric and - _ ( ) { } characters with no spaces <br> *Note: To use "&", enter \\&amp;
